-- Up 
CREATE TABLE IF NOT EXISTS player(id integer not null primary key, name varchar(100) not null, tag varchar(10), idx integer, discord_id varchar(100), udate datetime);
